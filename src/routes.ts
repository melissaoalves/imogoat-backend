...
routes.post(
  "/create-immobile",
  authMiddleware,
  new ImmobileController().createImmobile
);
routes.put(
  "/alter-immobile/:id",
  authMiddleware,
  new ImmobileController().updateImmobile
);
routes.delete(
  "/delete-immobile/:id",
  authMiddleware,
  new ImmobileController().deleteImmobile
);
...
routes.post(
  ...
  Multer.array("url", 5),
  uploadImovel,
  new ImageController().createImage
);
...
routes.post(
  "/create-feedback",
  authMiddleware,
  new FeedbackController().createFeedback
);
routes.put(
  "/alter-feedback/:id",
  authMiddleware,
  new FeedbackController().updateFeedback
);
routes.delete(
  "/delete-feedback/:id",
  authMiddleware,
  new FeedbackController().deleteFeedback
);
